...
mount_path   = "/root/asr/data" #📌 must change for user 
...
cache_path   = "root/asr/data/tmp"
if not os.path.exists(cache_path): os.mkdir(cache_path)

config_path  = "/root/asr/connection.cfg"
...
if __name__ == "__main__":
    ...
    bashCommand = "blobfuse /root/asr/data --tmp-path=/root/asr/tmp  --config-file=/root/asr/connection.cfg -o nonempty"
